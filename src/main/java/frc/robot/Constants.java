...
public final class Constants {
    ...
    public static final class AlgaeWristConstants {
        ...
        public static final double MIN_ANGLE_UNITS = 0.0;  // Placeholder
        public static final double MAX_ANGLE_UNITS = 0.0;    // Placeholder
        public static final double OFFSET_UNITS = 0.0;       // Placeholder
        // Additional preset angles for Algae Wrist positions (in units; placeholders)
        public static final double REEF_ANGLE_UNITS = 0.0;    // Placeholder value for reef angle
        public static final double LAYUP_ANGLE_UNITS = 0.0;   // Placeholder value for layup angle
        public static final double PLACE_ANGLE_UNITS = 0.0;   // Placeholder value for place angle
    ...
    public static final class ClimberConstants {
        ...
        public static final double WINCH_EXTENSION_UNITS = 2.0; // Placeholder value
        public static final double WINCH_CLIMB_UNITS = 1.8;     // Placeholder value
    }
    ...
    public static final class ElevatorConstants {
        ...
        public static final double HOME_HEIGHT_UNITS = 0.0;
        public static final double L1_SCORE_HEIGHT_UNITS = 0.5;
        public static final double L2_SCORE_HEIGHT_UNITS = 0.75;
        public static final double L3_SCORE_HEIGHT_UNITS = 1.0;
        public static final double L4_SCORE_HEIGHT_UNITS = 1.25;
        public static final double ALGAE_LAYUP_HEIGHT_UNITS = 0.6;
        public static final double ALGAE_PLACE_HEIGHT_UNITS = 0.8;
    }
